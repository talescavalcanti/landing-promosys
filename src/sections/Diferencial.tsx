    ...
    <section className="w-full py-24 relative z-10">
      <div className="max-w-6xl mx-auto px-4 flex flex-col items-center gap-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          <Reveal delay={0.2}>
            <div className="glass group p-8 flex flex-col gap-4 h-full transform hover:-translate-y-2 hover:border-royal/40 hover:shadow-[0_8px_30px_rgba(49,121,219,0.15)] transition-all duration-500 cursor-default">
